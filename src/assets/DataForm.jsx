...
const DataForm = () => {
    ...
    useEffect(() => {
        axios.get('https://extraordinary-moxie-659951.netlify.app/.netlify/functions/api/')
            .then((response) => {
    ...
    const handleSubmit = (e, id = null) => {
        ...
        const url = editItem
            ? `https://extraordinary-moxie-659951.netlify.app/.netlify/functions/api/${editItem._id}`
            : `https://extraordinary-moxie-659951.netlify.app/.netlify/functions/api/`;
    ...
    const handleDelete = (_id) => {
        axios
            .delete(
                `https://extraordinary-moxie-659951.netlify.app/.netlify/functions/api/${_id}`
            )
            .then(() => {
